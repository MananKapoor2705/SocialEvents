...
namespace API.Controllers
{
    public class ActivitiesController : BaseApiController
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateActivity(Activity updatedActivity, Guid id)
        {
            updatedActivity.Id = id;
            return Ok(await Mediator.Send(new Edit.Command { updatedActivity = updatedActivity }));
        }
